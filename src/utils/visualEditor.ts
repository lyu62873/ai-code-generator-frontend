/**
 * Visual editor utility: manages in-iframe visual editing
 */
      ...
      (function() {
        ...
        window.addEventListener('message', (event) => {
         ...
         function showEditTip() {
           ...
           tip.id = 'edit-tip';
           tip.innerHTML = '🎯 Edit mode on<br/>Hover to inspect, click to select element';
           tip.style.cssText = \`
             position: fixed;
             top: 20px;
             right: 20px;
