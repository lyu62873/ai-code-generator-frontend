<template>
  <div id="userLoginPage">
    <h2 class="title">AI Code Generator - Login</h2>
    <div class="desc">Generate full applications without writing a single line of code</div>
...
const handleSubmit = async (values: any) => {
  ...
  // On success, persist login state globally
